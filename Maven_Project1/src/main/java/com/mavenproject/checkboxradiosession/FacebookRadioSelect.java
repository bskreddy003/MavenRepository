...
public class FacebookRadioSelect {
	public static void facebookradioselect(String reqgender) {
		WebDriverManager.chromedriver().setup();
		WebDriver driver= new ChromeDriver();
		driver.manage().window().maximize();
		driver.manage().deleteAllCookies();
		driver.get("https://www.facebook.com/reg/?next=%2Fsignin");
